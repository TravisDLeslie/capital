              ...
              return (
                <tr key={r.id} className="hover:bg-slate-50">
                  ...
                  <Td className="text-center">
                    {fire ? (
                      <span title="Fire Rated" className="text-lg">
                        🔥
                      </span>
                    ) : (
                  ...
                  <Td className="text-center">
                    {cool ? (
                      <span title="Cool Rated" className="text-lg">
                        ❄️
                      </span>
                    ) : (
                      <span className="text-slate-200">—</span>
...
function Th({
  ...
  return (
    <th
      className={`border-b border-slate-200 px-4 py-3 whitespace-nowrap ${className}`}
    >
      {children}
    </th>
  );
